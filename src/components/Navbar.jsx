...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <motion.div 
        className="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden px-4 py-2 mx-auto transition-all duration-300 rounded-full md:flex md:px-6 md:py-3 lg:px-8 lg:py-4"
        style={{
        ...
        <div className="flex items-center justify-center space-x-3 md:space-x-6 lg:space-x-8">
          ...
          >
            <Link to="/" className="flex items-center justify-center space-x-1 md:space-x-2">
              ...
              >
                <AiOutlineHome className="w-5 h-5 text-blue-500 md:w-6 md:h-6 lg:w-6 lg:h-6" />
              </motion.div>
          ...
          {navItems.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium text-white md:text-base">{item.name}</span>
              </Link>
            </motion.div>
          ))}
          ...
          >
            ...
            >
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-purple-500 md:w-6 md:h-6 lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="text-sm font-medium text-white md:text-base">CV</span>
            </Link>
          </motion.div>
        </div>
      ...
      >
        ...
        <Link to="/" className="flex items-center space-x-2">
          ...
          <span className="text-base font-medium text-white">Aysha Urmi</span>
        </Link>
        
        {/* Hamburger button */}
        <motion.button
          className="p-2 text-white rounded-full hamburger-button bg-blue-500/20"
          whileTap={{ scale: 0.9 }}
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            className="fixed inset-0 z-40 flex mobile-menu md:hidden"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            {/* Drawer */}
            <motion.div
              className="absolute top-0 right-0 w-3/4 h-full p-4 pt-16 overflow-y-auto shadow-xl bg-bg-secondary/95 backdrop-blur-md"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
            ...
            >
              {/* Close button */}
              <button 
                className="absolute p-2 text-white rounded-full top-4 right-4 bg-blue-500/20"
                onClick={() => setMenuOpen(false)}
              >
              ...
              <div className="flex flex-col space-y-4">
                ...
                <Link 
                  to="/" 
                  className="flex items-center p-3 space-x-3 transition-colors rounded-lg hover:bg-blue-500/10"
                  onClick={() => setMenuOpen(false)}
                >
                  <div className="p-2 rounded-full bg-blue-500/20">
                    <AiOutlineHome className="text-xl text-blue-500" />
                  </div>
              ...
              <div className="flex justify-center mt-8 space-x-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-2 text-white rounded-full bg-blue-500/10"
                >
